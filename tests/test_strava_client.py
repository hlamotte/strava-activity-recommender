...
class Test_Strava_Client:
    ...
    def test_no_oauth_get(self, mock_open, mock_load, mock_post, mock_get):
        """
        Testing mocked API get request without using OAuth.
        """
        client = Strava_Client('secrets_path.json')
    ...
    def test_oauth_get(self, mock_open, mock_load, mock_post, mock_fetch, mock_get):
        """
